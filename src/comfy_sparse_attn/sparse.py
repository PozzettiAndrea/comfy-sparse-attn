"""
comfy/sparse.py — sparse data types for ComfyUI.

Provides VarLenTensor (packed variable-length sequences) and SparseTensor
(sparse 3-D voxel data with optional conv-backend acceleration).

Conv backend detection lives in .detect; spatial ops (SparseDownsample,
SparseUpsample, etc.) belong in the consuming model and are not part of
ComfyUI core.
"""
from typing import *
import logging
